...
M.get_integrations = function()
	local integrations_dir = vim.fn.stdpath("config") .. "/lua/themes/integrations/"
...
M.get_theme_tb = function(type)
	...
	local present1, default_theme = pcall(require, "themes.schemes." .. name)
...
local mixcolors = require("themes.colors").mix
...
M.extend_default_hl = function(highlights, integration_name)
	...
	if vim.g.transparency then
		local glassy = require("themes.transparency")
...
M.set_color_vars = function()
	...
	local present1, default_theme = pcall(require, "themes.schemes." .. vim.g.nvimTheme)

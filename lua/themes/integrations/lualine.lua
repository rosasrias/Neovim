...
local theme = {
  ...
  LualineDiagnosticsInfoIcon = { fg = colors.nord_blue, bg = colors.one_bg },
  LualineDiagnosticsHintIcon = { fg = colors.nord_blue, bg = colors.one_bg },
  LualineDiagnosticsErrorText = { fg = colors.red, bg = colors.one_bg },
  LualineDiagnosticsWarnText = { fg = colors.yellow, bg = colors.one_bg },
  LualineDiagnosticsInfoText = { fg = colors.nord_blue, bg = colors.one_bg },
  LualineDiagnosticsHintText = { fg = colors.nord_blue, bg = colors.one_bg },

  -- Grupos activos
  LualineDotIcon = { bg = colors.nord_blue, fg = colors.black },
  ...
  -- Lualine por modo
  LualineModeNormalIcon = { fg = colors.black, bg = colors.nord_blue },
  ...
  LualineModeTerminalIcon = { fg = colors.black, bg = colors.nord_blue },
  LualineModeSelectIcon = { fg = colors.black, bg = colors.dark_purple },

  LualineModeNormalText = { fg = colors.nord_blue, bg = blend(colors.nord_blue, colors.black, 0.1), bold = true },
  ...
  LualineModeTerminalText = { fg = colors.nord_blue, bg = blend(colors.nord_blue, colors.black, 0.1), bold = true },
  LualineModeSelectText = { fg = colors.dark_purple, bg = blend(colors.dark_purple, colors.black, 0.1), bold = true },

  LualineModeNormalSeparator = { fg = colors.nord_blue, bg = blend(colors.nord_blue, colors.black, 0.1) },
  ...
  LualineModeTerminalSeparator = { fg = colors.nord_blue, bg = blend(colors.nord_blue, colors.black, 0.1) },
  LualineModeSelectSeparator = { fg = colors.dark_purple, bg = blend(colors.dark_purple, colors.black, 0.1) },

  LualineModeNormalSeparator2 = { fg = blend(colors.nord_blue, colors.black, 0.1), bg = colors.grey },
  ...
  LualineModeTerminalSeparator2 = { fg = blend(colors.nord_blue, colors.black, 0.1), bg = colors.grey },

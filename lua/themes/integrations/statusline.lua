...
return {
  ...
  StalineVenvIcon = { bg = colors.sun, fg = colors.black },
  StalineVenvName = { bg = colors.black, fg = colors.sun },
  ...
  StalineNormalMode = { bg = colors.nord_blue, fg = colors.black, bold = true },
  StalineVisualMode = { bg = colors.yellow, fg = colors.black, bold = true },
  StalineCommandMode = { bg = colors.orange, fg = colors.black, bold = true },
  StalineInsertMode = { bg = colors.green, fg = colors.black, bold = true },
  StalineTerminalMode = { bg = colors.purple, fg = colors.black, bold = true },
  StalineNTerminalMode = { bg = colors.purple, fg = colors.black, bold = true },
  StalineConfirmMode = { bg = colors.teal, fg = colors.black, bold = true },
  StalineNormalModeSep = { fg = colors.nord_blue, bg = colors.grey },
